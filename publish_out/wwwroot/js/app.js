...
function loadSettings() {
    const lcz = localStorage.getItem('--lcz-color') || DEFAULT_COLORS['--lcz-color'];
    const hcz = localStorage.getItem('--hcz-color') || DEFAULT_COLORS['--hcz-color'];
    const ez = localStorage.getItem('--ez-color') || DEFAULT_COLORS['--ez-color'];
    const txt = localStorage.getItem('--text-primary') || DEFAULT_COLORS['--text-primary'];
...
window.resetSettings = function() {
    ...
    localStorage.removeItem('ezNaming');
...
window.renderTemplateButtons = function() {
    ...
    keys.forEach(key => {
        ...
        const cAliases = {
            'LC_1': '1 Clothes', 'LC_2': '2 Stool', 'LC_3': '3 Contoller',
            'LC_4': '4 Brain', 'LC_5': '5 Skull',
            'EZ_1': '1 Rectangle', 'EZ_2': '2 Hangbag', 'EZ_3': '3 Fractured',
